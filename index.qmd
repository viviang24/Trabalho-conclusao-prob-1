...
<details>
<summary>Código: Gráfico em python Lepidocyrtus sp.n.5</summary>
```python
# Lepidocyrtus sp.n.5
import numpy as np
...
<details> <summary>Código: Gráfico python Lepidocyrtinus</summary>
```python
...
<details> <summary>Código: Gráfico python Rhynchocyrtus sp.n.1</summary>
```python
...
<details> <summary>Código: Gráfico python Simulação Monte Carlo</summary>
```python
n_especies = 43
prob_pitfall = 0.8837
n_sim = 10000
